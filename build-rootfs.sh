...
#  including i18n support, update system, and app center
# ================================================
...
echo "[5/8] Installing i18n framework..."
...
echo "[6/8] Installing version file..."
cp "$SRC/config/version" "$ROOTFS/etc/basic-os/version"

# ---- Install system scripts ----
echo "[7/8] Installing system scripts..."
